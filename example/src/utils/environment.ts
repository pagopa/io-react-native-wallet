import {
  ...
  PRE_WALLET_EAA_PROVIDER_BASE_URL_V1_4,
  PRE_WALLET_PID_PROVIDER_BASE_URL_V1_0,
  PRE_WALLET_PID_PROVIDER_BASE_URL_V1_4,
  ...
  PROD_WALLET_EAA_PROVIDER_BASE_URL_V1_4,
  PROD_WALLET_PID_PROVIDER_BASE_URL_V1_0,
  PROD_WALLET_PID_PROVIDER_BASE_URL_V1_4,
  ...
  switch (env) {
    case "pre":
      return {
        ...
        X509_CERT_ROOT: PRE_X509_CERT_ROOT,
      };
    case "prod":
      return {
        ...
        X509_CERT_ROOT: PROD_X509_CERT_ROOT,
      };
  }
};
