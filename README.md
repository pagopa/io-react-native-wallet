...
> [!WARNING]
> `io-react-native-wallet` is undergoing a refactor to support multiple IT-Wallet versions and may exhibit inconsistent usage across modules. This will be fixed automatically with the complete refactor.
